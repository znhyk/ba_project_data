...
csvfile = "./dagagu_add_district.csv"
...
for line in rdr:
    if line[0] == "long":
        csvline = line
        csvline.insert(2,"gbd_path_type")
        csvline.insert(3,"gbd_total_time")
        csvline.insert(4,"gbd_transfer_count")
        csvline.insert(5,"gbd_total_distance")
        csvline.insert(6,"gbd_total_walk_distance")
        csvline.insert(7,"gbd_total_fare")
